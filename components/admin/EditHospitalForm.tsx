...
const EditHospitalForm: React.FC<HospitalFormProps> = ({ id }) => {
  const { hospitalDetail, isLoading }: any = useHospitalDetail(id || "");
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      postalcode: hospitalDetail?.postalcode || "",
      photo: hospitalDetail?.photo || "",
      ...
      content: hospitalDetail?.content || "",
  ...
  useEffect(() => {
    form.setValue("name", hospitalDetail?.name || "");
    form.setValue("email", hospitalDetail?.email || "");
    form.setValue("address", hospitalDetail?.address || "");
    form.setValue("phone", hospitalDetail?.phone || "");
    form.setValue("photo", hospitalDetail?.photo || "");
    form.setValue("state", hospitalDetail?.state || "");
    form.setValue("postalcode", hospitalDetail?.postalcode || "");
    form.setValue("city", hospitalDetail?.city || "");
    form.setValue("country", hospitalDetail?.country || "");
    form.setValue("place_id", hospitalDetail?.place_id || "");
    form.setValue("latitude", hospitalDetail?.latitude || "");
    form.setValue("longitude", hospitalDetail?.longitude || "");
    form.setValue("content", hospitalDetail?.content || "");
    form.setValue("road", hospitalDetail?.road || "");
  }, [hospitalDetail, form]);
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    console.log("hospital details formdata", values);
    try {
