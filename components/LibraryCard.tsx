...
const LibraryCard = ({hospital_photo, hospital_address, hospital_name,place_id}:LibraryCardProps) => {
    ...
    <div className='py-4'>
      <div className="grid grid-cols-6 gap-2 md:grid-cols-8 lg:grid-cols-12">
        <div className="col-span-4 md:col-span-6 lg:col-span-9 bg-gray-200 max-w-[1004px] min-h-[64px] max-h-[97px] rounded-2xl overflow-auto ">
          <Link href={`/find-hospital/${place_id}`}className="flex items-center py-2 px-2 md:gap-8">
            <Image
              src={hospital_photo}
              alt="hospital image"
              width={50}
